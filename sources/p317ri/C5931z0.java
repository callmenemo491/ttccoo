...
public class C5931z0 extends p317ri.AbstractC5912s implements p317ri.InterfaceC5926x {

    /* renamed from: Y */
    public final byte[] f22759Y;

    public C5931z0(byte[] r1) {
            r0 = this;
            r0.<init>()
            r0.f22759Y = r1
            return
    ...
    public boolean mo12203n(p317ri.AbstractC5912s r2) {
            r1 = this;
            boolean r0 = r2 instanceof p317ri.C5931z0
            if (r0 != 0) goto L6
            r2 = 0
            return r2
        L6:
            ri.z0 r2 = (p317ri.C5931z0) r2
            byte[] r0 = r1.f22759Y
            byte[] r2 = r2.f22759Y
