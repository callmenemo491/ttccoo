...
public class C5866c1 extends p317ri.AbstractC5912s implements p317ri.InterfaceC5926x {

    /* renamed from: Y */
    public byte[] f22680Y;

    public C5866c1(byte[] r1) {
            r0 = this;
            r0.<init>()
    ...
    public boolean mo12203n(p317ri.AbstractC5912s r2) {
            r1 = this;
            boolean r0 = r2 instanceof p317ri.C5866c1
            if (r0 != 0) goto L6
            r2 = 0
            return r2
        L6:
            byte[] r0 = r1.f22680Y
            ri.c1 r2 = (p317ri.C5866c1) r2
            byte[] r2 = r2.f22680Y
