...
public final class C2980z8 implements android.os.Parcelable.Creator<p124h7.C2962y8> {
    public C2980z8() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final p124h7.C2962y8 createFromParcel(android.os.Parcel r7) {
            r6 = this;
    ...
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ p124h7.C2962y8[] newArray(int r1) {
            r0 = this;
            h7.y8[] r1 = new p124h7.C2962y8[r1]
            return r1
    }
}
