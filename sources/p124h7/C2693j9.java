...
public final class C2693j9 implements android.os.Parcelable.Creator<p124h7.C2675i9> {
    public C2693j9() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final p124h7.C2675i9 createFromParcel(android.os.Parcel r7) {
            r6 = this;
    ...
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ p124h7.C2675i9[] newArray(int r1) {
            r0 = this;
            h7.i9[] r1 = new p124h7.C2675i9[r1]
            return r1
    }
}
