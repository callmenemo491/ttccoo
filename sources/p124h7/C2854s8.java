...
public final class C2854s8 implements android.os.Parcelable.Creator<p124h7.C2836r8> {
    public C2854s8() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final p124h7.C2836r8 createFromParcel(android.os.Parcel r8) {
            r7 = this;
    ...
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ p124h7.C2836r8[] newArray(int r1) {
            r0 = this;
            h7.r8[] r1 = new p124h7.C2836r8[r1]
            return r1
    }
}
