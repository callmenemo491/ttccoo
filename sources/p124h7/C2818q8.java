...
public final class C2818q8 implements android.os.Parcelable.Creator<p124h7.C2800p8> {
    public C2818q8() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final p124h7.C2800p8 createFromParcel(android.os.Parcel r8) {
            r7 = this;
    ...
    @Override // android.os.Parcelable.Creator
    public final /* bridge */ /* synthetic */ p124h7.C2800p8[] newArray(int r1) {
            r0 = this;
            h7.p8[] r1 = new p124h7.C2800p8[r1]
            return r1
    }
}
