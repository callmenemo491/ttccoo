...
public class C0279h extends android.widget.CheckBox {

    /* renamed from: a0 */
    public final androidx.appcompat.widget.C0283j f1301a0;

    /* renamed from: b0 */
    public final androidx.appcompat.widget.C0273f f1302b0;

    /* renamed from: c0 */
    public final androidx.appcompat.widget.C0313y f1303c0;

    public C0279h(android.content.Context r2, android.util.AttributeSet r3) {
            r1 = this;
    ...
    public C0279h(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
    ...
    public void drawableStateChanged() {
            ...
            androidx.appcompat.widget.f r0 = r1.f1302b0
            if (r0 == 0) goto La
            r0.m711a()
        La:
            androidx.appcompat.widget.y r0 = r1.f1303c0
            if (r0 == 0) goto L11
            r0.m834b()
        L11:
            return
    ...
    public android.content.res.ColorStateList getSupportButtonTintList() {
            r1 = this;
            androidx.appcompat.widget.j r0 = r1.f1301a0
            if (r0 == 0) goto L7
    ...
    public void setBackgroundDrawable(android.graphics.drawable.Drawable r1) {
            ...
            androidx.appcompat.widget.f r1 = r0.f1302b0
            if (r1 == 0) goto La
            r1.m715e()
        La:
            return
    ...
    public void setButtonDrawable(android.graphics.drawable.Drawable r2) {
            ...
            androidx.appcompat.widget.j r2 = r1.f1301a0
            if (r2 == 0) goto L15
